...
class LowrankModel(nn.Module):
    def __init__(self,
                 ...
                 offset_lambda: float = 0.1,
                 offset_freeze_iter: int = 50000,
        ...
        self.offset_freeze_iter = offset_freeze_iter
        self.test_optim = test_optim
    ...
    def forward(self, rays_o, rays_d, bg_color, near_far: torch.Tensor, timestamps=None, camids=None, global_step=None):
        """
        rays_o : [batch, 3]
        rays_d : [batch, 3]
        timestamps : [batch]
    ...
    def get_params(self, lr: float):
        ...
        return [
            ...
            {"params": offset_params, "lr": lr * self.offset_lambda}
        ]

...
def config_parser(cmd=None):
    ...
    # time mlp
    parser.add_argument('--no_load_timequery', action='store_true')
    parser.add_argument("--time_freq", type=int, default=10)
    ...
    parser.add_argument("--n_iters_pre", type=int, default=10000)
    ...
    # network decoder
    parser.add_argument("--time_head_pre", type=str, default='dyrender')
    ...
    ## blender flags
    parser.add_argument("--chromakey", action='store_true',
    ...
    # etc
    parser.add_argument("--test_cam_offset", type=float, default=0, help='')
    parser.add_argument('--test_optim', action='store_true')
    parser.add_argument("--n_iters_test", type=int, default=500)
